...
ggplot(graf, aes(x=ANO4, y=ITF)) +
  ...
  labs(title = "Evolución de los ingresos totales familiares promedio según clase social",
       subtitle = "Argentina urbana. 2004-2023 (En dólares PPA corrientes)",
       caption = "Fuente: Elaboración propia en base a EPH-INDEC",
       color = "Clase social") +
  theme(axis.title.x = element_blank(),
        axis.title.y = element_blank(),
  ...
  scale_x_continuous(limits = c(2004, 2023), breaks = seq(2004, 2023, 1))
...
ggplot(graf, aes(x=Año, y=theil, colour = tipo)) +
  ...
  theme(axis.title.x = element_blank(),
        ...
        legend.title = element_text(size = 10, face = "bold"),
        legend.text = element_text(size = 10)) +
  scale_color_d3(labels = c("Theil Laboral", "Theil Total")) +
...
ggplot(graf, aes(x=Año, y=porcentaje, colour = tipo)) +
  ...
  labs(title = "Descomposición del coeficiente de Theil. Componente inter-clases (Hogares)",
       subtitle = "Argentina urbana. 2003-2024 (en porcentajes)",
       caption = "Fuente: Elaboración propia en base a EPH-INDEC",
       color = "Tipo") +
  theme(axis.title.x = element_blank(),
        axis.title.y = element_blank(),
